...
@media (max-width: 680px) {
  ...
  /* Make control cluster scrollable horizontally if it gets too wide */
  .tools {
    overflow-x: auto;
  ...
  /* Popovers: turn into bottom-sheet style on small screens */
  .popover {
    position: fixed;
    left: 8px;
    right: 8px;
  ...
  .canvas-wrap {
    margin: 0 -10px;      /* edge-to-edge on phone */
    border-radius: 0;
  }
